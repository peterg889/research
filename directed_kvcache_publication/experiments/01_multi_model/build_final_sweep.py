#!/usr/bin/env python3
"""Build the final publication sweep: 4 models x 18 conditions x 6 datasets x 400 samples.

Comprehensive experiment for the paper. Includes:
...
- All models use BOS (Qwen gets PAD), GSM8K number-only answer
...
Usage:
    ...
    python3 experiments/01_multi_model/build_final_sweep.py
    cd experiments/01_multi_model
    papermill 01_final_sweep.ipynb 01_final_sweep_executed.ipynb --no-progress-bar
"""
...
# Write notebook
# =====================================================================
out_path = "experiments/01_multi_model/01_final_sweep.ipynb"
