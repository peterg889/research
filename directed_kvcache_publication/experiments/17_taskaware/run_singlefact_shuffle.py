...
MODELS = {
    ...
    # Round 2 (2026-07): hunt a NON-GEMMA TOKEN-PRESENCE imprinter (magnitude + order-invariant). RoPE-validated.
    "llama3_8b":    {"name": "NousResearch/Meta-Llama-3-8B-Instruct", "loader": "AutoModelForCausalLM"},  # Llama-3 (plain rope)
    "yi15_9b":      {"name": "01-ai/Yi-1.5-9B-Chat", "loader": "AutoModelForCausalLM"},                   # Yi 1.5 (Llama arch)
    "falcon3_7b":   {"name": "tiiuae/Falcon3-7B-Instruct", "loader": "AutoModelForCausalLM"},             # Falcon3
