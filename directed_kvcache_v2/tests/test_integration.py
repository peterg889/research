...
def test_corrected_cache_matches_direct(model_and_tokenizer, config):
    ...
    # Both build_kv_cache and build_truncated_kv_cache_corrected include BOS
    # in their returned length: build_kv_cache returns total tokens (BOS + doc),
    # build_truncated_kv_cache_corrected returns keep_len = 1 (BOS) + doc_len.
    assert corrected_len == direct_len
