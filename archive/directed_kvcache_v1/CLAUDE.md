...
- **Truncated oracle > truncated random** (Exp 18): 62% win rate, p<1e-6
- **BUT: All priming hurts average performance on MS MARCO** (Exp 18): even oracle d=-0.11
- **Hardness gating works** (Exp 13B): r=0.302 between difficulty and benefit
- **LLM surrogates work** (Exp 14D): Intent-based generation (d=0.274) matches real queries
